...
public class ToggleDevelopPanelSetActiveAutoClearTaskUI : MonoBehaviour
{
    ...
    private AutoClearTaskUI_GetPatchDKO _logicAutoClearTaskUI;
    ...
    private void CheckInit()
    {
        if (_getDkoPatchLogger.Init == true)  
        {
            _logicAutoClearTaskUI = _getDkoPatchLogger.GetDKO<DKODataInfoT<AutoClearTaskUI_GetPatchDKO>>().Data;
