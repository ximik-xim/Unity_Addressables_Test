...
/// и за запуск загрузки Addressables сцен
/// (нужен именно в таком ввиде, т.к загрузку сцен надо делать ПОЛСЕ обновлений)
/// </summary>
public class TaskLoggerUpdateAllObjectAndLoadSceneAddressables : AbsTaskLoggerLoaderDataMono
{
    [Header("---------")]
    [SerializeField]
    ...
    [SerializeField]
    private LoadLocalAndRemoteSceneAddressables _sceneLoad;
