...
/// </summary>
public class StorageAbsGetKeyScene : MonoBehaviour
{
    ...
    [SerializeField] 
    private List<AbsGetStorageKeyNameScene> _storageSceneLevel;
    
    private void Awake()
    {
        List<AbsGetStorageKeyNameScene> _buffer = new List<AbsGetStorageKeyNameScene>();
        bool _isStart = false;
    ...
    public List<KeyNameScene> GetAllKeyScene()
    {
