...
/// </summary>
public class StorageTextureSceneUI : MonoBehaviour
{
    ...
    [SerializeField]
    private DataStorageTextureSceneUI _defaultTexture;
    
    //Список исключений. Нужен в случ. если опр. сцене, нужно задать опр. номер на сцене
    [SerializeField]
    private AbsExceptionsListStorageTextureSceneUI _listExceptions;

    private Dictionary<string, DataStorageTextureSceneUI> _exceptionsTextureData = new Dictionary<string, DataStorageTextureSceneUI>();
    ...
    public DataStorageTextureSceneUI GetTextureUI(KeyNameScene keyNameScene)
    {
